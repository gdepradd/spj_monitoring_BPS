...
<head>
    ...
    <title>403 - SPJ Monitoring BPS</title>
...
<body class="flex min-h-screen items-center justify-center bg-ui-page p-4 text-ui-text">
    <div class="max-w-lg rounded-2xl border border-ui-border bg-ui-card p-8 text-center">
        <p class="text-5xl font-bold text-status-neutral">403</p>
        <h1 class="mt-4 text-2xl font-bold">Akses Ditolak</h1>
        <p class="mt-2 text-ui-muted">Anda tidak memiliki hak akses untuk membuka halaman ini.</p>
